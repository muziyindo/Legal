							...
							<!--Modal for status change-->
								...
								<div class="m-portlet">
									...
									<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="form_contract" enctype="multipart/form-data" accept-charset="utf-8" method="post">
										...
										<div class="m-portlet__body">
											...
											<div class="form-group m-form__group row">
												<div class="col-lg-4">
													...
													<input type="text" class="form-control m-input" placeholder="" name="authorized_signatory" required>
													<span class="m-form__help">
										...
										<p><div id="doc_error" style="color:red; font-weight:bold; text-align:center"></div></p>
										<div class="m-portlet__head bg-light">
										<div class="m-portlet__head-caption">
											<div class="m-portlet__head-title">
												<span class="m-portlet__head-icon m--hide">
